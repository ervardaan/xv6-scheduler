...
// Check if running process has lock
// If yes, check other processes and check if they are sleeping
// If they are sleeping and the channel matches the lock that is currently being held
// Get their nice value and use that to 
